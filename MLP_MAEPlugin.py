...
class MLP_MAEPlugin:
 ...
 def output(self, outputfile):
  ...
  model_load = load_model(PyPluMA.prefix()+"/saved_model/mlp.h5")
  ...
  inv_y.to_csv(outputfile+"/inv_y_mlp.csv")
  inv_yhat.to_csv(outputfile+"/inv_yhat_mlp.csv")
  error.to_csv(outputfile+"/error_mlp.csv")
